...
(function($){
  ...
  $('#btnGenerate').click(function(){
    ...
    $("#outputArea").val(generateLicense(email));
  });
})(jQuery);
...
function injectFile(path) {
  var jar1 = fs.readFileSync("./media/net.xmind.verify_3.5.0.201410310637.jar");
  var jar2 = fs.readFileSync("./media/org.xmind.meggy_3.5.0.201410310637.jar");
  fs.writeSync(path + "/plugins/net.xmind.verify_3.5.0.201410310637.jar",jar1);
  fs.writeSync(path + "/plugins/org.xmind.meggy_3.5.0.201410310637.jar",jar2);
}
